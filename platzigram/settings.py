...
SECRET_KEY = 'ne8#u+6^9a_utnsen4-f8@kp#5t!#^pp(27aqj^^v9v@v+a52)'
...
# Once created the login_required decorator on the views, we need to create the LOGIN_URL constant
